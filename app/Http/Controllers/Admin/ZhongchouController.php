...
class ZhongchouController extends Controller
{
    ...
    //手动结束众筹
    public function zhongchouEnd(Request $request)
    {
        if (empty($_GET['id'])) {
            $this->display('Public:404');
            exit();
    ...
    //手动开始众筹
    public function zhongchouStart(Request $request)
    {
        if (empty($_GET['id'])) {
            $this->display('Public:404');
            exit();
    ...
    //解冻众筹记录
    public function jiedongById(Request $request)
    {
        $id = I('get.id');
    ...
    //解冻众筹全部冻结
    public function jiedongByIid(Request $request)
    {
        $id = I('post.iid');
    ...
    public function jiedong_start(Request $request)
    {
        $id = I('post.iid');
