...
class PayController extends Controller
{
    ...
    //人工充值AJAX处理方式
    public function rechargeByMan(Request $request)
    {
        $config = $this->config;
        $member = $this->member;
    ...
    //币充值页面
    public function bpay(Request $request)
    {
    ...
    //提币的页面
    public function tcoin(Request $request)
    {
...
//      $result = $bitcoin->getinfo();
     ...
     * 添加钱包提现地址
     */
    public function add_qianbao_address(Request $request)
    {
        $cuid = I("currency_id");//货币id
    ...
    public function chongzhi_function(Request $request)
    {
...
//      $result = $bitcoin->getinfo();
    ...
    public function rpc2(Request $request)
    {
        require_once 'App/Common/Common/easybitcoin.php';
